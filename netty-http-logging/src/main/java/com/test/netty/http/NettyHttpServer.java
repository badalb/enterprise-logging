...
public final class NettyHttpServer {
	...
	public static void main(String[] args) throws Exception {
		...
		try {
			...
			b.option(ChannelOption.SO_BACKLOG, 1048576);
			b.group(bossGroup, workerGroup).channel(NioServerSocketChannel.class)
					.handler(new LoggingHandler(LogLevel.INFO)).childHandler(new HttpServerInitializer(sslCtx));
			b.option(ChannelOption.SO_RCVBUF, 10048576);
			b.option(ChannelOption.RCVBUF_ALLOCATOR, new FixedRecvByteBufAllocator(10048576));
